...
import com.ucacue.udipsai.modules.sedes.domain.repository.SedeRepositorio;
...
public class PacienteService {
    ...
    public PacienteDTO convertToDTO(Paciente paciente) {
        ...
        dto.setDocumentos_paciente(paciente.getDocumentos_paciente());
        ...
        // Verificación de ficha unica
        if (paciente.getFichaUnica() != null) {
            dto.setFichaUnica(new DocumentoIdDTO(paciente.getFichaUnica().getId()));
        } else {
            dto.setFichaUnica(null);
        }
